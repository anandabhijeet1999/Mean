  ...
  return (
    <div className={theme == "light" ? lightTheme : darkTheme}>
      <div className="flex-1">
        <Link to="/home">
          <img
            className="h-16 mx-20 justify-self-auto"
            src={image1}
            alt="AMAZIA"
          />
        </Link>
      ...
      <li>
        <Link to="/Food" className="text-red-700">
          FOOD
        </Link>
      </li>
        ...
        <div className="dropdown dropdown-end">
          ...
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
            <div className="indicator">
              <Link to="/cart">
              <sup className="bg-red-500 top-2 text-lg rounded-full w-5 h-5"> {cartData.length} </sup>
                <svg
